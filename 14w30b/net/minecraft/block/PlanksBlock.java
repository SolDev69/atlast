...
public class PlanksBlock extends Block {
   ...
   public BlockState getStateFromMetadata(int metadata) {
      return this.defaultState().set(VARIANT, PlanksBlock.Variant.byIndex(metadata));
   }
   ...
   public static enum Variant implements StringRepresentable {
      ...
      private static final PlanksBlock.Variant[] ALL = new PlanksBlock.Variant[values().length];
      ...
      public static PlanksBlock.Variant byIndex(int index) {
      ...
      static {
         for(PlanksBlock.Variant var3 : values()) {
