...
public class Items {
   ...
   private static Item get(String id) {
      return (Item)Item.REGISTRY.get(new Identifier(id));
   }
   ...
   static {
      if (!Bootstrap.isInitialized()) {
         ...
         WHEAT = get("wheat");
         BREAD = get("bread");
         LEATHER_HELMET = (ArmorItem)get("leather_helmet");
         LEATHER_CHESTPLATE = (ArmorItem)get("leather_chestplate");
         LEATHER_LEGGINGS = (ArmorItem)get("leather_leggings");
         LEATHER_BOOTS = (ArmorItem)get("leather_boots");
         CHAINMAIL_HELMET = (ArmorItem)get("chainmail_helmet");
         CHAINMAIL_CHESTPLATE = (ArmorItem)get("chainmail_chestplate");
         CHAINMAIL_LEGGINGS = (ArmorItem)get("chainmail_leggings");
         CHAINMAIL_BOOTS = (ArmorItem)get("chainmail_boots");
         IRON_HELMET = (ArmorItem)get("iron_helmet");
         IRON_CHESTPLATE = (ArmorItem)get("iron_chestplate");
         IRON_LEGGINGS = (ArmorItem)get("iron_leggings");
         IRON_BOOTS = (ArmorItem)get("iron_boots");
         DIAMOND_HELMET = (ArmorItem)get("diamond_helmet");
         DIAMOND_CHESTPLATE = (ArmorItem)get("diamond_chestplate");
         DIAMOND_LEGGINGS = (ArmorItem)get("diamond_leggings");
         DIAMOND_BOOTS = (ArmorItem)get("diamond_boots");
         GOLDEN_HELMET = (ArmorItem)get("golden_helmet");
         GOLDEN_CHESTPLATE = (ArmorItem)get("golden_chestplate");
         GOLDEN_LEGGINGS = (ArmorItem)get("golden_leggings");
         GOLDEN_BOOTS = (ArmorItem)get("golden_boots");
         FLINT = get("flint");
         ...
         EGG = get("egg");
         COMPASS = get("compass");
         FISHING_ROD = (FishingRodItem)get("fishing_rod");
         CLOCK = get("clock");
         ...
         COOKIE = get("cookie");
         FILLED_MAP = (FilledMapItem)get("filled_map");
         SHEARS = (ShearsItem)get("shears");
         MELON = get("melon");
         ...
         FIREWORKS_CHARGE = get("firework_charge");
         ENCHANTED_BOOK = (EnchantedBookItem)get("enchanted_book");
