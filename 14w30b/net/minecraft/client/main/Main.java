...
public class Main {
   public static void main(String[] args) {
      ...
      ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("Player" + MinecraftClient.getTime() % 1000L, new String[0]);
      ...
      if (var23 != null) {
         try {
            var24 = new Proxy(Type.SOCKS, new InetSocketAddress(var23, var21.valueOf(var8)));
      ...
      if (!var24.equals(Proxy.NO_PROXY) && isNotNullOrEmpty(var25) && isNotNullOrEmpty(var26)) {
      ...
      PropertyMap var33 = (PropertyMap)new GsonBuilder()
      ...
      RunArgs var42 = new RunArgs(
         new RunArgs.User(var41, var33, var24),
         new RunArgs.Display(var27, var28, var29, var30),
         new RunArgs.Directories(var34, var36, var35, var38),
         new RunArgs.Game(var31, var32),
         new RunArgs.Server(var39, var40)
      );
